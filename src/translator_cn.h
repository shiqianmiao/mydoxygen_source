...
//////////////////////////////////////////////////////////////////////////
      ...
      // used as the title of the HTML page of a class/struct/union
    {
      ...
      switch(compType)
      {
        case ClassDef::Class:  result+=CN_SPC"包"; break;
      ...
      //result+="的说明文档";
      //我的自定义过滤ServiceApp的内容
      int pos = result.find("ServiceApp");
      //截取到末尾，同时保留最后面的 包字
      int offset = result.length() - pos;
      if (pos) {
           result = result.replace(pos, offset, "");
      }
...
//////////////////////////////////////////////////////////////////////////
    ...
    { // here s is one of " Class", " Struct" or " Union"
      ...
      switch(compType)
      {
        case ClassDef::Class:      result+="包"; break;
        case ClassDef::Struct:     result+="结构体"; break;
        case ClassDef::Union:      result+="联合体"; break;
        case ClassDef::Interface:  result+="接口"; break;
        case ClassDef::Protocol:   result+="协议"; break;
